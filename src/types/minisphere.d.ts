...
declare class BlendOp {
  ...
  static Default: BlendOp;
  static Add: BlendOp;
  static Average: BlendOp;
  static Multiply: BlendOp;
  static Replace: BlendOp;
...
declare namespace Dispatch {
  ...
  function onUpdate(
    fn: Function,
    options?: { inBackground: boolean; priority: number }
  ): JobToken;
  /**
...
declare module "prim" {
  ...
  export function drawSolidTriangle(
    target: Surface,
    x: number,
    y: number,
    x2: number,
  ...
  export function drawSolidEllipse(
    surface: Surface,
    x: number,
    y: number,
    rx: number,
...
declare module "tween" {
  ...
  export default class Tween<T> {
    ...
    easeIn(newValues: TweenableOnly<T>, frames: number): Promise<void>;
    easeOut(newValues: TweenableOnly<T>, frames: number): Promise<void>;
    easeInOut(newValues: TweenableOnly<T>, frames: number): Promise<void>;
  }
}
